      ...
      <div className="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div className="flex items-center md:p-8 p-6 bg-[#FBF6E9] md:rounded-tl-[55px] md:rounded-bl-[55px] h-full">
          <form className="max-w-lg w-full mx-auto" onSubmit={handleLogin}>
            <div className="mb-12">
              <h3 className="text-[#FF6600] text-4xl font-bold">Sign in</h3>
              <p className="text-gray-800 text-sm mt-4">
                Don't have an account?{" "}
                <a href="/" className="text-[#FF6600] font-semibold hover:underline ml-1 whitespace-nowrap">
                  Register here
                </a>
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-gray-300 rounded accent-[#FF6600]"
                />
            ...
            <div className="mt-12">
              <button
                type="submit"
                className="w-full py-3 px-6 text-sm font-semibold tracking-wider rounded-full text-white bg-[#FF6600] hover:bg-[#FF7F3E] focus:outline-none"
              >
                Sign in
              </button>
            </div>
